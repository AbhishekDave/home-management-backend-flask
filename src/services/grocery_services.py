...
from src.utils.error_handling_utility.exceptions import ConflictException
...
class GroceryService:
    ...
    def create_grocery(self, grocery_name_data):
        ...
        """
        current_user_id = self.user_service.find_current_user()
    ...
    def find_grocery_name_by_user_and_name(self, user_id, grocery_name):
        """
        Searches the database for grocery name associated with specific user and returns it.
