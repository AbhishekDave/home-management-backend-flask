# src/apis/grocery_api/user_type_get.py
...
def get_user_with_a_grocery_name_lists():
    ...
    dependency_container = current_app.dependency_container
    user_service = dependency_container.get_service('user_service')
    user_serialization_service = dependency_container.get_service('user_serialization_service')
